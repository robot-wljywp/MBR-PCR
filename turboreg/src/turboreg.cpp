...
RigidTransform TurboRegGPU::runRegCXX(torch::Tensor &kpts_src, torch::Tensor &kpts_dst, torch::Tensor &kpts_src_copy, torch::Tensor &kpts_dst_copy)
{
    ...
    RigidTransform trans_final(best_trans);
    return trans_final;
}

torch::Tensor TurboRegGPU::runRegCXXReturnTensor(torch::Tensor &kpts_src_all, torch::Tensor &kpts_dst_all, torch::Tensor &kpts_src_copy, torch::Tensor &kpts_dst_copy)
{
    return runRegCXX(kpts_src_all, kpts_dst_all, kpts_src_copy, kpts_dst_copy).getTransformation();
}