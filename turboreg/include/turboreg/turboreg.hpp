...
namespace turboreg
{
    ...
    public:
        ...
        RigidTransform runRegCXX(torch::Tensor &kpts_src, torch::Tensor &kpts_dst, torch::Tensor &kpts_src_copy, torch::Tensor &kpts_dst_copy);
        torch::Tensor runRegCXXReturnTensor(torch::Tensor &kpts_src_all, torch::Tensor &kpts_dst_all, torch::Tensor &kpts_src_copy, torch::Tensor &kpts_dst_copy);
